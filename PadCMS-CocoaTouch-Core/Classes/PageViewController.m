...
-(void)loadFullView
{
	...
	//CGSize scrollContentSize = CGSizeMake(body.size.width, body.size.height); 	
	//NSLog(@"!!!!! - %@, %@",body.dataRects, NSStringFromCGSize(body.size));
	...
	CGSize scrollContentSize = CGSizeMake(768.0, height); 
